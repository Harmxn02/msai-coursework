...
You might want to take more time for the `System setup'. You have 3-4 spare weeks to allocate, so perhaps you can take 2 weeks for this instead of just 1? Writing a lot of code to set up an entire system can be more time-consuming than expected, and it's important to have a good system in place before you start making analyses. It's a bad habit of mine to want to start the analyses as soon as possible, but then I later find out the system isn't working properly and I have to go back and fix it.
