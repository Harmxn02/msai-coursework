...
% \citet{friedman2013vsd}'s Value Sensitive Design framework adds to this by specifying indirect stakeholders, those affected without directly using the system, such as civilians in the target environment.
